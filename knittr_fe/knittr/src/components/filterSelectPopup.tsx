...
const FilterSelectPopup = ({ sizes, yarns, cats, selectedSizes, selectedYarns, selectedCats, handleSize, handleYarn, handleCat }: { sizes: Size[], yarns: Yarn[], cats: Category[], selectedSizes: Set<number>, selectedYarns: Set<number>, selectedCats: Set<number>, handleSize: ToggleEventHandler, handleYarn: ToggleEventHandler, handleCat: ToggleEventHandler }) => {
